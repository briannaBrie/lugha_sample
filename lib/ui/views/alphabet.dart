...
import '../../core/model/alphabet_data.dart';
...
class _AlphabetState extends State<Alphabet> {
  var currentPage = alphabet_images.length - 1.0;
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    PageController controller = PageController(
        initialPage: alphabet_images.length - 1, viewportFraction: 0.8);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'With the Alphabet in the cards below, each letter has a distinct word.\nEach word helps you helps improve your vocabulary and also offers a way to remember the pronunciations especially of the dietrics',
                ...
                children: <Widget>[
                  ...
                  Positioned.fill(
                    child: PageView.builder(
                      itemCount: alphabet_images.length,
    ...
    return Directionality(
      ...
      child: AspectRatio(
        ...
        child: LayoutBuilder(builder: (context, contraints) {
          ...
          for (var i = 0; i < alphabet_images.length; i++) {
